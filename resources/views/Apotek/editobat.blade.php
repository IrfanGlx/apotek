          ...
          <div class="row">
            <div class="col-md-12">
              <div class="card">
                ...
                <div class="card-body">
                  <form action="{{ route('editObatAction')}}" method="POST">
			{{ csrf_field() }}
                    ...
                    <div class="row">
                      <div class="col-md-8 offset-md-2">
                        <div class="form-group">
                          ...
                          <input type="text" value="{{ $obat->nama }}" name="namaObat" class="form-control">
                        </div>
                      </div>
                      <div class="col-md-8 offset-md-2">
                        <div class="form-group">
                          <label class="bmd-label-floating">Jumlah</label>
                          <input type="number" value="{{ $obat->jumlah }}" name="jumlahObat" class="form-control">
                        </div>
                      </div>
